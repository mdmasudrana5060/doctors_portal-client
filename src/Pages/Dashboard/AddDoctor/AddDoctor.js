...
const AddDoctor = () => {
    ...
    const { data: specialities, isLoading } = useQuery({
        queryKey: ['speciality'],
        queryFn: async () => {
            const res = await fetch(`https://doctors-portal-server-ten-sand.vercel.app/appointmentSpeciality`);
        ...
        fetch(url, {
            ...
            .then(result => {
                ...
                if (result.success) {
                    ...
                    fetch('https://doctors-portal-server-ten-sand.vercel.app/doctors', {
                        method: "POST",
                        headers: {
